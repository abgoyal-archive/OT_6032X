					    ...
					    struct wpa_ssid *group)
{
	...
	for (ssid = group; ssid; ssid = ssid->pnext) {
        ...
        //update this threshold for PR408982 by songfang
        char wifi_connect_threshold[10];
        // CR463230 BEGIN---Change WIFI 3G fall back threshold---QIHONG.XU@TCL.COM---Jun 04,2013
        //property_get("ro.wifi.connect.threshold", wifi_connect_threshold, "-85");
        property_get("ro.wifi.connect.threshold", wifi_connect_threshold, "-100");
        // CR463230 END---Change WIFI 3G fall back threshold---QIHONG.XU@TCL.COM---Jun 04,2013
