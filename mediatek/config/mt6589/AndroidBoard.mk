...
# added by cai.jin@tcl.com for Dolby -- begin
ifeq ($(DOLBY_DAP),yes)
$(info -----mediatek/config/mtk6589/AndroidBoard.mk------- define DOLBY_DAP)
  PRODUCT_COPY_FILES += $(LOCAL_PATH)/scribepro_media_codecs.xml:system/etc/media_codecs.xml
else 
$(info -----mediatek/config/mtk6589/AndroidBoard.mk------- define !DOLBY_DAP)
  PRODUCT_COPY_FILES += $(LOCAL_PATH)/media_codecs.xml:system/etc/media_codecs.xml
endif
# added by cai.jin@tcl.com for Dolby -- end
...
_scribe_pro_td_compass_cfg := $(MTK_ROOT_CONFIG_OUT)/configs/accel_nvm
ifeq ("scribeprotd","$(TARGET_PRODUCT)")
ifneq ($(wildcard $(_scribe_pro_td_compass_cfg)),)
PRODUCT_COPY_FILES += $(_scribe_pro_td_compass_cfg):system/etc/accel_nvm
endif
endif
