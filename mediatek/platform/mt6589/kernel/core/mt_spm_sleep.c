...
/*I have merged a tmp patch(the commit: 58b2b852d46d86ef862218588b0227e844cdf670)
 * which is released by MTK for rav4 tmous branch before. Then I received MTK's officail patch
 * for scribepro. And I found that the tmp patch is the same with this official one. So I just 
 * added this comment to mark this merging.*/
/**************************************
