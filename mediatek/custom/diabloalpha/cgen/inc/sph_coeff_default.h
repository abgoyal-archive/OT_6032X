...
#define DEFAULT_SPEECH_NORMAL_MODE_PARA \
    64,   253, 16388,    14, 57351,  31,   400,   0,\
   336,  4325,   611,     0, 29192,      371|SPEECH_MODE_PARA13,     407|SPEECH_MODE_PARA14,  8192

#define DEFAULT_SPEECH_EARPHONE_MODE_PARA \
     0,   253, 10756,    14, 57351,  31,   400,   130,\
   272,  4325,   611,     0, 25864,     0,     0,     0
...
#define DEFAULT_SPEECH_LOUDSPK_MODE_PARA \
   128,   224,  2218,    30, 57351, 31,   400,   148,\
   342,  4325,   611,     0, 16392,     0,     0,  0
...
#define DEFAULT_WB_SPEECH_NORMAL_MODE_PARA \
    64,   253, 16388,    14, 57607,  31,   400,    32,\
   336,  4325,   611,     0, 29192,    371|SPEECH_MODE_PARA13,     407|SPEECH_MODE_PARA14,  8192  

#define DEFAULT_WB_SPEECH_EARPHONE_MODE_PARA \
     0,   253, 10756,    14, 57607,  31,   400,   130,\
   272,  4325,   611,     0, 25864,     0,     0,     0
...
#define DEFAULT_WB_SPEECH_LOUDSPK_MODE_PARA \
   128,   224,  2218,    30, 57351, 31,   400,   131,\
   342,  4325,   611,     0, 16392,     0,     0,  8192
