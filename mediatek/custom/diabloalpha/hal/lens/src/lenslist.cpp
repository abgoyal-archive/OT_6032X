...
#if defined(OV8825SUNNYAF)//liwenyuan@tcl 20130717 for bug :490545 +
extern PFUNC_GETLENSDEFAULT pOV8825SUNNYAF_getDefaultData;
#endif//liwenyuan@tcl 20130717 for bug :490545 -
...
//modified by zhfan, pr450349, porting diablox main camera imx135 VCM driver dw9714a
    ...
    {IMX135_LENS50016_SENSOR_ID, DW9714A_LENS_ID, "DW9714A", pDW9714A_getDefaultData},
#endif
    //  for new added lens, need assign correct SensorID
#if defined(OV8825SUNNYAF)//liwenyuan@tcl 20130717 for bug :490545 +
		{OV8825_SENSOR_ID, OV8825SUNNYAF_LENS_ID, "OV8825SUNNYAF", pOV8825SUNNYAF_getDefaultData},
#endif//liwenyuan@tcl 20130717 for bug :490545 -
};
