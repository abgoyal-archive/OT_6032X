...
refine_CCM(RAWIspCamInfo const& rCamInfo, IspNvramRegMgr const& rIspRegMgr, ISP_NVRAM_CCM_T& rCCM)
{
	...
	//					 THH2  TH2	THL2				   THH1  TH1  THL1
		...
		case eIDX_Shading_CCT_D65:
		 ...
		 switch(eIdx_Shading_CCT_new)
	   {
			 case eIDX_Shading_CCT_ALight:
			 rCCM.conv0a.val=0x077101B5;
			 rCCM.conv0b.val=0x000007DA;
			 rCCM.conv1a.val=0x017907AE;
			 rCCM.conv1b.val=0x000007D9;
			 rCCM.conv2a.val=0x069A07EC;
			 rCCM.conv2b.val=0x0000027A;
			 break;
			 case eIDX_Shading_CCT_CWF:
			 rCCM.conv0a.val=0x06950269;
			 rCCM.conv0b.val=0x00000002;
			 rCCM.conv1a.val=0x01980791;
			 rCCM.conv1b.val=0x000007D7;
			 rCCM.conv2a.val=0x072307FB;
			 rCCM.conv2b.val=0x000001E2;
			 break;
			 case eIDX_Shading_CCT_D65:
			 
#if 0
			  rCCM.conv0a.val=0x079001BE;
			  rCCM.conv0b.val=0x000007B2;
			  rCCM.conv1a.val=0x016A07BE;
			  rCCM.conv1b.val=0x000007D8;
			  rCCM.conv2a.val=0x07900009;
			  rCCM.conv2b.val=0x00000167;
#else
			  rCCM.conv0a.val=0x06D00230;
			  rCCM.conv0b.val=0x00000000;
			  rCCM.conv1a.val=0x019507C7;
			  rCCM.conv1b.val=0x000007A4;
			  rCCM.conv2a.val=0x074C0005;
			  rCCM.conv2b.val=0x000001AF;
#endif
			 break;
