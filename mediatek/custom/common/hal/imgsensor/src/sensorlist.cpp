...
#if defined(IMX135_LENS50016_MIPI_RAW)
extern UINT32 CAM_CALGetCalData_IMX135Lens50016rRAW(UINT32* pGetSensorCalData);
#endif

#if defined(IMX135_MIPI_RAW)
extern UINT32 CAM_CALGetCalData_IMX135RAW(UINT32* pGetSensorCalData);
#endif
...
#if defined(IMX135_LENS50016_MIPI_RAW)
    RAW_INFO(IMX135_LENS50016_SENSOR_ID, SENSOR_DRVNAME_IMX135_LENS50016_MIPI_RAW,CAM_CALGetCalData_IMX135Lens50016rRAW),
#endif
//[end]496059 zhfan
#if defined(IMX135_MIPI_RAW)
//[Begin]zhfan for sunny module otp PR 450709
    RAW_INFO(IMX135_SENSOR_ID, SENSOR_DRVNAME_IMX135_MIPI_RAW,CAM_CALGetCalData_IMX135RAW), 
//[End]
#endif
#if defined(IMX135TRULY_MIPI_RAW)
//[Begin]zhfan for sunny module otp PR 450709
