...
extern int Camera_debug_on;
#define SENSORDB(fmt, arg...) if(Camera_debug_on)printk("%s: " fmt "\n", __FUNCTION__ ,##arg)
#define SENSORDB_AWAYSON(fmt, arg...) printk("%s: " fmt "\n", __FUNCTION__ ,##arg)
//#else
//#define SENSORDB(x,...)
//#endif
...
static void OV5648MIPI_Sensor_Init(void)
{
    ...
    */
    ...
    OV5648MIPI_write_cmos_sensor(0x3013, 0x08); //liwenyuan ext DVDD
...
UINT32 OV5648MIPIOpen(void)
{
	...
	SENSORDB_AWAYSON("[LEE]OV5648MIPIOpen enter:");
    ...
    spin_unlock(&ov5648mipi_drv_lock);
	SENSORDB_AWAYSON("[LEE]OV5648MIPIOpen exit:");
	return ERROR_NONE;
}   /*  OV5648MIPIOpen  */
